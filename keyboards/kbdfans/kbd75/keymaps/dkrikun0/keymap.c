...
// unused, various shift lock variants
#if 0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   KC_MENU,  KC_SPC,                       KC_RALT,  MO(_FL),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    #if 0
    case _ML:
        rgblight_sethsv_noeeprom(172,139,141);
        break;
    #endif
    default:
        rgblight_sethsv_noeeprom_white();;
