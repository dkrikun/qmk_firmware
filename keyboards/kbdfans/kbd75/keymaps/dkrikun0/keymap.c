...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   KC_MENU,  KC_BSPC,                      KC_RALT,  TT(_ML),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [_FL] = LAYOUT(
    ...
    RESET,    _______,  _______,                      KC_ENT,   RGB_TOG,  _______,                      _______,  _______,  _______,  _______,  _______,  _______
  ),
  ...
  [_ML] = LAYOUT(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      KC_BTN3,  KC_MS_WH_DOWN,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_BTN2,            KC_MS_U,  KC_MS_WH_RIGHT,
    _______,  _______,  _______,                      _______,  _______,  _______,                      _______,  _______,  KC_BTN1,  KC_MS_L,  KC_MS_D,  KC_MS_R
  ),
};
